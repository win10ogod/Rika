 ...
 * @type {string[]}
 */
export const RikaWords = ['理華', 'rika']
...
/**
 * 清除使用者用户在指定频道的正在输入时间戳（通常在使用者发送消息后调用）。
 * @param {string | number} channelId - 频道 ID。
 */
...
/**
 * 检查使用者用户是否在指定时间窗口内（默认2秒）有正在输入的通知。
 * @param {string | number} channelId - 频道 ID。
 * @param {number} [timeWindowMs=3000] - 时间窗口（毫秒）。
 * @returns {boolean} 如果使用者在时间窗口内有正在输入的通知，则返回 true。
 */
