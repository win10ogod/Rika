...
export function buildPlatformAPI(interfaceConfig) {
	...
	const telegramPlatformAPI = {
		...
		/**
		 * 获取使用者的 Telegram 用户名。
		 * @returns {string} - 使用者的 Telegram 用户名。
		 */
		getOwnerUserName: () => interfaceConfig.OwnerUserName,
		/**
		 * 获取使用者的 Telegram 用户 ID。
		 * @returns {string} - 使用者的 Telegram 用户 ID。
		 */
		...
		/**
		 * (可选) 优化方法：一次性获取使用者在哪些群组中、不在哪些群组中。
		 * @returns {Promise<{groupsWithOwner: import('../../bot_core/index.mjs').GroupObject[], groupsWithoutOwner: import('../../bot_core/index.mjs').GroupObject[]} | null>} - 包含使用者所在群组和不在群组的列表。
		 */
