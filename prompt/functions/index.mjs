...
import { SkillsPrompt } from './skills.mjs'
import { SubAgentPrompt } from './sub-agent.mjs'
...
export async function FunctionPrompt(args, logical_results) {
	const result = []
	result.push(SkillsPrompt(args, logical_results))
	result.push(DeepResearchPrompt(args, logical_results))
	result.push(SubAgentPrompt(args, logical_results))
