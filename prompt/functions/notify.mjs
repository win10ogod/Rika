...
/**
 * 通知功能 Prompt：在回复对象非使用者或用户提及“通知”等词时激活，指导 AI 使用 <notify> / <system-notify>。
...
像这样：
理華: 我注意到使用者的领带没系好，得通知使用者一下才行。
<notify color="#FF0000" fontSize="20">使用者！领带没系好哦！</notify>
notify可以通知你使用者，其实现方式是未定义的，可能通过聊天软件的私信、系统通知等方式发送给用户。颜色和字体大小也不保证一定生效。

如果你希望发送一个系统弹窗确保给“电脑前的人”而不是你使用者，你可以使用<system-notify>：
<system-notify>
通知内容
</system-notify>
